...
// 禁止所有中断
void disable_all_interupt(void)
{
	// 为什么在中断初始化之初要禁止所有中断？
...
void irq_handler(void)
{
	...
	unsigned long vicstatus[4] = {VIC0IRQSTATUS,VIC1IRQSTATUS,VIC2IRQSTATUS,VIC3IRQSTATUS};
